...
class mobil{
    ...
    function jalan_maju(){
        return "Vrcoommm maju";
     }
    function jalan_mundur(){
        return "vrcrommmm citt mundur";
     }
}
// instansiasi (menginstankan variabel yang menghubukan dari class keluar class)
